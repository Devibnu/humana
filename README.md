...
## Usage
Register a user or login with one of the baseline accounts below after running the migrations and seeders:

- admin@humana.test / secret
- manager@humana.test / secret
- employee@humana.test / secret

Besides the dashboard, the auth pages, the billing and table pages, there is also has an edit profile page. All the necessary files are installed out of the box and all the needed routes are added to `routes/web.php`. Keep in mind that all of the features can be viewed once you login using the credentials provided or by registering your own user. 

## Baseline User Verification
Setelah menjalankan `php artisan migrate:fresh --seed`, jalankan:

```bash
php artisan tinker --execute="App\\Models\\User::all()->pluck('email')"
```
...
- admin@humana.test
- manager@humana.test
- employee@humana.test

Baseline credentials for UI login:
...
### Login
If you are not logged in you can only access this page or the Sign Up page. The default url takes you to the login page where you can use one of the baseline credentials `admin@humana.test / secret`, `manager@humana.test / secret`, or `employee@humana.test / secret`. Logging in is possible only with already existing credentials. For this to work you should have run the migrations and seeders.
