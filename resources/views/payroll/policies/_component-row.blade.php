...
<div class="accordion-item policy-component" data-component-row data-component-kind="{{ $isDefault ? 'default' : 'custom' }}">
    ...
    <div id="{{ $collapseId }}" class="accordion-collapse collapse {{ $isOpen ? 'show' : '' }}" aria-labelledby="{{ $collapseId }}-heading" data-bs-parent="#policy-components-accordion">
        <div class="accordion-body policy-component-body">
            ...
            @unless($isDefault)
                <button type="button" class="btn btn-link text-secondary policy-remove-component mb-0 p-0" data-remove-component title="Hapus komponen">
