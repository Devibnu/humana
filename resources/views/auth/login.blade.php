      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Login ke akun Anda untuk mengakses dashboard HRIS: absensi, cuti, payroll, dan laporan karyawan.</p>
          </div>
        </div>
      </div>
    </div>
              ...
              <form role="form" method="POST" action="{{ route('session.store') }}">
                ...
                <div class="text-center">
                  <small class="text-muted">Forgot your password?
                    <a href="{{ url('/login/forgot-password') }}" class="text-dark font-weight-bolder">Reset it here</a>
                  </small>
                </div>
                <p class="text-sm mt-3 mb-0 text-center">Don't have an account? <a href="{{ url('/register') }}" class="text-dark font-weight-bolder">Sign up</a></p>
              </form>
            </div>
          </div>
        </div>
