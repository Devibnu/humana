    ...
    <div class="col-12">
        <div class="card mx-4 mb-4 shadow-xs">
            <div class="card-header pb-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h5 class="mb-1">Ubah Jenis Cuti</h5>
                    <p class="text-sm text-secondary mb-0">Perbarui aturan lampiran, approval, dan tenant untuk menjaga kebijakan cuti tetap konsisten.</p>
                </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('jenis-cuti.update', $type) }}" method="POST" data-testid="leave-types-edit-form">
                    @csrf
                    @method('PUT')
